...
export const Group = types
    ...
    .actions(self => {
        // Only these actions have access to controller. This is volatile state, state that lives as long as the instance of the Group lives
        let controller

        return {
            // Lifecycle hook: Always run after instance is created
            afterCreate() {
                self.load()
            },
            load: flow(function* load() {
                // Allows to abort one or more DOM requests as and when desired.
